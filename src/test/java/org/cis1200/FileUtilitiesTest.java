...
public class FileUtilitiesTest {
    ...
    final String testFile = "./files/twitterbot_test.csv";
    ...
    public void writeStringsToFileNoAppendTest() {
        assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
            ...
            // TwitterBot tb = new TwitterBot(FileUtilities.fileToReader(testFile), 1);
    ...
    public void testFileToReader() {
        assertTimeoutPreemptively(Duration.ofSeconds(10), () -> {
            BufferedReader csvReader = FileUtilities.fileToReader("./files/tweetparser_test.csv");
            ...
            List<String> rawTweets = new LinkedList<>();
            String line = csvReader.readLine();
            while (line != null) {
                rawTweets.add(line);
                line = csvReader.readLine();
            }
            assertEquals(expected, rawTweets);
        });
    }
